		...
		if (_.options.buttonType === 'arrows') {
			...
			_.$carouselItems.each(function(_index, item) {
				$('<button/>', {
					...
					text: _.options.showIndicatorNumbers ? _index + 1 : '',
				...
				}).appendTo($('.sc__indicator-container'));
			});
		}
...
// $('.sc__carousel').scrollCarousel({buttonType: 'indicators', showIndicatorNumbers: true, disableAnimation: true});
